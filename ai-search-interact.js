...
window.addEventListener('DOMContentLoaded',()=>{
 ...
 $('#paidCta')?.addEventListener('click',()=>{track('paid_click','geo_intro_19800');setReply('先着10社19,800円の詳細版へ進みます。会社名・サイトURL・業種・主サービスを入力し、決済後に3AI×12問の実測レポートを作成します。');});
});
